...
class AutoBlind:
	...
	def __init__(self,smarthome, cycle = 300, item_id_height = 'hoehe', item_id_lamella = 'lamelle', log_level = 0, log_directory = '/usr/local/smarthome/var/log/AutoBlind/', manual_break_default=3600):
		logger.info("Init AutoBlind (cycle={0}, item_id_height={1}, item_id_lamella={2}".format(cycle, item_id_height, item_id_lamella));
